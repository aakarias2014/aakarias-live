...
async function main() {
  ...
  const articles = [
       ...
       ═════════════════════════════════════════════════════════════════════════ */
    {
      ...
      title: "देश की पहली ड्रोन बटालियन: पंजाब में शुरुआत — आधुनिक सुरक्षा, रक्षा तकनीक व MPPSC/UPSC विश्लेषण",
      titleEn: "India's First Drone Battalion Established in Punjab — Modern Security & MPPSC/UPSC Analysis",
      excerpt: "आधुनिक टेस्टिंग, सीमा सुरक्षा और अवैध ड्रोन घुसपैठ रोकने के लिए पंजाब में देश की पहली ड्रोन बटालियन शुरू की गई है। जानिए इसके तकनीकी पहलू, ड्रोन नियम 2021 व MPPSC/UPSC नोट्स।",
      excerptEn: "India's first specialized Drone Battalion launched in Punjab for advanced border testing, surveillance, and counter-drone operations. Read detailed MPPSC & UPSC notes.",
      ca_date: "2026-09-08",
      publishedAt: new Date().toISOString(),
      featured: true,
      readingTime: 9,
       ...
       ═════════════════════════════════════════════════════════════════════════ */
    {
      ...
      title: "विश्व का पहला स्वायत्त समुद्री जहाज निर्माण केंद्र: आंध्र प्रदेश में स्थापना — MPPSC व UPSC परीक्षा विश्लेषण",
      titleEn: "World's First Autonomous Shipbuilding Centre in Andhra Pradesh — Blue Economy & MPPSC/UPSC Notes",
      excerpt: "भारत में आंध्र प्रदेश के तटीय क्षेत्र में विश्व का पहला स्वायत्त समुद्री जहाज निर्माण केंद्र (World's First Autonomous Shipbuilding Hub) स्थापित किया जा रहा है। जानिए मैरीटाइम टेक और परीक्षा हेतु मुख्य बिंदु।",
      excerptEn: "India is establishing the world's first autonomous shipbuilding facility in Andhra Pradesh to pioneer AI-navigated maritime vessels and Blue Economy growth. Read detailed MPPSC & UPSC notes.",
      ca_date: "2026-09-08",
      publishedAt: new Date().toISOString(),
      featured: true,
      readingTime: 9,
