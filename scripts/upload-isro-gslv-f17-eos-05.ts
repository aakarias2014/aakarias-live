  ...
  const article: any = {
    ...
    body: [
      ...
      ...createBlocks([
        ...
        "• **तृतीय चरण (Cryogenic Stage - CUS15)**: स्वदेशी **क्रायोजेनिक अपर स्टेज (CUS-15)**, जो तरल हाइड्रोजन (LH₂) और तरल ऑक्सीजन (LOX) का उपयोग करता है।",
    ...
    bodyEn: [
      ...
      ...createBlocks([
        ...
        "• **Third Stage (Cryogenic Stage - CUS15)**: Indigenous **Cryogenic Upper Stage (CUS-15)**, fueled by Liquid Hydrogen (LH₂) and Liquid Oxygen (LOX).",
