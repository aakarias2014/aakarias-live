...
async function main() {
  console.log("📸 Starting upload of custom Ariha Pangambam Gold Medal Thumbnail...");

  const imagePath = path.resolve(process.cwd(), "public/images/blog/ariha-pangambam-custom-thumbnail.png");
  ...
  const asset = await client.assets.upload("image", fs.createReadStream(imagePath), {
    filename: "ariha_pangambam_custom_thumbnail.png",
  });
  ...
  const featuredImageObj = {
    ...
    alt: "अरिहा पंगमबम (Ariha Pangambam) - एशियन एयरोबिक जिम्नास्टिक चैंपियनशिप स्वर्ण पदक विजेता",
    caption: "चित्र: अरिहा पंगमबम, उनके मुख्य कोच युमनाम रंजन सिंह एवं एशियन एयरोबिक जिम्नास्टिक चैंपियनशिप में भारत का पहला स्वर्ण पदक।",
  };
