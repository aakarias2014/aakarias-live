...
async function main() {
  console.log("🚀 Starting upload process for 73rd and 74th Amendments Article...");
      ...
      /* ── 2. 73rd Amendment ───────────────────────────────────── */
      {
        ...
        body: [
          ...
          },
          {
            ...
            children: [{ _key: "s2-12", _type: "span", text: "  1. ग्राम पंचायत (ग्राम स्तर पर)" }],
          },
          {
  ...
  try {
    ...
    console.log("✨ Successfully uploaded 73rd and 74th Amendments Article to Sanity!");
  } catch (err) {
