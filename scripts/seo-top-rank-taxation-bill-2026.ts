...
async function main() {
  console.log("🎨 Formatting and Cleaning UI Structure for Taxation Bill 2026 in Sanity CMS...");
  ...
  const caArticle = {
    ...
    excerpt: "संसद से पारित कराधान एवं अन्य विधियाँ (संशोधन) विधेयक, 2026 का संपूर्ण विश्लेषण। वित्त मंत्रालय, आयकर अधिनियम 2025, सरकारी प्रतिभूतियों में FII कर छूट, हीरा उद्योग (2026-2041), इलेक्ट्रॉनिक्स विनिर्माण (2040-41), फंड नियम छूट (4 शर्तें समाप्त), REIT/InvIT SPV अधिभार (10% से 25%) तथा डेटा सेंटर प्रावधान। MPPSC & UPSC नोट्स।",
    excerptEn: "Complete notes on Taxation and Other Laws (Amendment) Bill, 2026 passed by Parliament. Ministry of Finance, Income Tax Act 2025, G-Secs FII tax exemption, rough diamond trade (2026-2041), electronics bonded warehouses, 4 fund rules removed, REIT/InvIT SPV surcharge (10% to 25%), and Data Centers for MPPSC & UPSC.",
    ca_date: "2026-08-12",
    ...
    sections: [
      /* ── 1. Quick Answer Box / Featured Snippet ──────────────── */
      {
        ...
        kind: "whyInNews",
        title: "कराधान एवं अन्य विधियाँ (संशोधन) विधेयक 2026 - त्वरित सारांश (Quick Summary Box)",
        titleEn: "Taxation and Other Laws Amendment Bill 2026 Quick Summary",
        body: [
          {
            _key: "fs-1", _type: "block", style: "normal",
            children: [{ _key: "fs-s1", _type: "span", text: "• **विधेयक का नाम**: कराधान एवं अन्य विधियाँ (संशोधन) विधेयक, 2026 / कराधान और अन्य कानून (संशोधन) विधेयक, 2026" }]
          },
          {
            _key: "fs-2", _type: "block", style: "normal",
            children: [{ _key: "fs-s2", _type: "span", text: "• **संबंधित मंत्रालय**: वित्त मंत्रालय (Ministry of Finance, Govt of India)" }]
          },
          {
            _key: "fs-3", _type: "block", style: "normal",
            children: [{ _key: "fs-s3", _type: "span", text: "• **संसदीय संचरण तिथि**: लोकसभा में प्रस्तुत (4 अगस्त 2026) | लोकसभा से पारित (6 अगस्त 2026) | राज्यसभा से पारित (10 अगस्त 2026)" }]
          },
          {
            _key: "fs-4", _type: "block", style: "normal",
            children: [{ _key: "fs-s4", _type: "span", text: "• **संशोधित मुख्य कानून**: आयकर अधिनियम 2025, वित्त अधिनियम 2026, भुगतान एवं निपटान प्रणाली अधिनियम 2007" }]
          },
          {
            _key: "fs-5", _type: "block", style: "h3",
            children: [{ _key: "fs-s5", _type: "span", text: "विधेयक के 6 मुख्य प्रावधान (6 Core Pillars):" }]
          },
          {
            _key: "fs-6", _type: "block", style: "normal",
            children: [{ _key: "fs-s6", _type: "span", text: "• **1. सरकारी प्रतिभूतियों (G-Secs) में FII/BIS को कर छूट**: ब्याज आय एवं पूंजीगत लाभ पर 1 अप्रैल 2026 से पूर्ण आयकर छूट।" }]
          },
          {
            _key: "fs-7", _type: "block", style: "normal",
            children: [{ _key: "fs-s7", _type: "span", text: "• **2. कच्चा हीरा उद्योग (SNZ) को कर छूट**: विशेष अधिसूचित क्षेत्र में कच्चे हीरों की बिक्री पर 1 अक्टूबर 2026 से 31 मार्च 2041 (15 वर्ष) तक कर राहत।" }]
          },
          {
            _key: "fs-8", _type: "block", style: "normal",
            children: [{ _key: "fs-s8", _type: "span", text: "• **3. इलेक्ट्रॉनिक्स विनिर्माण प्रोत्साहन**: पूंजीगत वस्तुओं एवं औजारों की आपूर्ति से जुड़ी कर छूट की सीमा 2030-31 से बढ़ाकर 2040-41 तक विस्तारित।" }]
          },
          {
            _key: "fs-9", _type: "block", style: "normal",
            children: [{ _key: "fs-s9", _type: "span", text: "• **4. भारत से प्रबंधित विदेशी निवेश फंड नियम**: पात्र विदेशी फंडों हेतु 4 कड़े प्रतिबंध (25 सदस्य, 10% सीमा, ₹100 करोड़ कोष, 25% इकाई सीमा) समाप्त।" }]
          },
          {
            _key: "fs-10", _type: "block", style: "normal",
            children: [{ _key: "fs-10-s", _type: "span", text: "• **5. REIT एवं InvIT SPV अधिभार**: व्यावसायिक ट्रस्टों के SPV हेतु अधिभार दर (Surcharge Rate) 10% से बढ़ाकर 25% तथा लाभांश कर छूट।" }]
          },
          {
            _key: "fs-11", _type: "block", style: "normal",
            children: [{ _key: "fs-11-s", _type: "span", text: "• **6. डेटा सेंटर क्षेत्र का विस्तार**: भारतीय कंपनियों द्वारा पट्टे पर संचालित डेटा सेंटरों हेतु आयकर छूट का विस्तार।" }]
          },
          {
            _key: "fs-12", _type: "block", style: "normal",
            children: [{ _key: "fs-12-s", _type: "span", text: "• **स्मरण सूत्र (Memory Formula)**: 2026 कराधान संशोधन = विदेशी निवेश + हीरा + इलेक्ट्रॉनिक्स + निवेश फंड + REIT/InvIT + डेटा सेंटर" }]
          },
        ],
        bodyEn: [
          {
            _key: "fs-13", _type: "block", style: "normal",
            children: [{ _key: "fs-s13", _type: "span", text: "• **Bill Name**: Taxation and Other Laws (Amendment) Bill, 2026" }]
          },
          {
            _key: "fs-14", _type: "block", style: "normal",
            children: [{ _key: "fs-s14", _type: "span", text: "• **Nodal Ministry**: Ministry of Finance, Govt of India" }]
          },
          {
            _key: "fs-15", _type: "block", style: "normal",
            children: [{ _key: "fs-s15", _type: "span", text: "• **Passing Dates**: Lok Sabha (Aug 6, 2026) | Rajya Sabha (Aug 10, 2026)" }]
          },
        ],
      },
      ...
      /* ── 2. Parliamentary Journey ────────────────────────────── */
      {
        ...
        titleEn: "Introduction & Key Legislative Timeline",
        body: [
          {
            _key: "b2-1", _type: "block", style: "normal",
            children: [{ _key: "s2-1", _type: "span", text: "• **संबंधित मंत्रालय (Ministry)**: वित्त मंत्रालय (Ministry of Finance, Government of India)" }]
          },
          {
            _key: "b2-2", _type: "block", style: "normal",
            children: [{ _key: "s2-2", _type: "span", text: "• **लोकसभा में प्रस्तुत तिथि**: 4 अगस्त 2026" }]
          },
          {
            _key: "b2-3", _type: "block", style: "normal",
            children: [{ _key: "s2-3", _type: "span", text: "• **लोकसभा से पारित तिथि**: 6 अगस्त 2026" }]
          },
          {
            _key: "b2-4", _type: "block", style: "normal",
            children: [{ _key: "s2-4", _type: "span", text: "• **राज्यसभा से पारित तिथि**: 10 अगस्त 2026" }]
          },
          {
            _key: "b2-5", _type: "block", style: "normal",
            children: [{ _key: "s2-5", _type: "span", text: "• **विधेयक का उद्देश्य**: यह विधेयक आयकर अधिनियम 2025 में संशोधनों के साथ वित्त अधिनियम 2026 और भुगतान एवं निपटान प्रणाली अधिनियम 2007 में बदलाव करता है।" }]
          },
          {
            _key: "b2-img-1", _type: "image",
            asset: { _type: "reference", _ref: assetParliamentId },
            alt: "Indian Parliament Sansad Bhavan with financial dashboard overlay",
          },
        ],
        bodyEn: [
          {
            _key: "b2-6", _type: "block", style: "normal",
            children: [{ _key: "s2-6", _type: "span", text: "• **Ministry**: Ministry of Finance" }]
          },
          {
            _key: "b2-7", _type: "block", style: "normal",
            children: [{ _key: "s2-7", _type: "span", text: "• **Passed Dates**: Lok Sabha (Aug 6, 2026), Rajya Sabha (Aug 10, 2026)" }]
          },
        ],
      },
      ...
      /* ── 3. Provisions 1 & 2: Foreign Investment & Diamond Industry ─ */
      {
        ...
        kind: "keyAspects",
        title: "सरकारी प्रतिभूतियों (G-Secs) में विदेशी निवेश तथा हीरा उद्योग हेतु कर राहत",
        titleEn: "G-Sec Foreign Investment & Diamond Industry Tax Exemption",
        body: [
          {
            _key: "b3-1", _type: "block", style: "h3",
            children: [{ _key: "s3-1", _type: "span", text: "1. सरकारी प्रतिभूतियों में विदेशी निवेश (Foreign Investment in G-Secs)" }]
          },
          {
            _key: "b3-2", _type: "block", style: "normal",
            children: [{ _key: "s3-2", _type: "span", text: "• **कर छूट प्रावधान**: निर्दिष्ट विदेशी संस्थागत निवेशकों को भारत की सरकारी प्रतिभूतियों (G-Secs) से होने वाली आय पर आयकर छूट का प्रावधान।" }]
          },
          {
            _key: "b3-3", _type: "block", style: "normal",
            children: [{ _key: "s3-3", _type: "span", text: "• **कर छूट में शामिल आय**: प्रतिभूतियों से प्राप्त **ब्याज (Interest Income)** तथा उनके हस्तांतरण से होने वाला **पूंजीगत लाभ (Capital Gains)**।" }]
          },
          {
            _key: "b3-4", _type: "block", style: "normal",
            children: [{ _key: "s3-4", _type: "span", text: "• **लागू होने की तिथि**: 1 अप्रैल 2026 या उसके बाद अर्जित आय पर प्रभावी।" }]
          },
          {
            _key: "b3-5", _type: "block", style: "normal",
            children: [{ _key: "s3-5", _type: "span", text: "• **प्रमुख पात्र संस्थाएं**: FII (विदेशी संस्थागत निवेशक) एवं BIS (बैंक फॉर इंटरनेशनल सेटलमेंट्स)।" }]
          },
          {
            _key: "b3-6", _type: "block", style: "h3",
            children: [{ _key: "s3-6", _type: "span", text: "2. कच्चा हीरा उद्योग को कर छूट (Tax Exemption to Diamond Sector)" }]
          },
          {
            _key: "b3-7", _type: "block", style: "normal",
            children: [{ _key: "s3-7", _type: "span", text: "• **प्रावधान विवरण**: विशेष अधिसूचित क्षेत्र (SNZ) में कच्चे हीरों (Rough Diamonds) की बिक्री से होने वाली आय पर विदेशी कंपनियों को कर राहत।" }]
          },
          {
            _key: "b3-8", _type: "block", style: "normal",
            children: [{ _key: "s3-8", _type: "span", text: "• **लाभार्थी इकाइयाँ**: हीरा खनन कंपनियां (Mining Firms), दलाल (Brokers), एग्रीगेटर तथा निविदा/नीलामी इकाइयाँ।" }]
          },
          {
            _key: "b3-9", _type: "block", style: "normal",
            children: [{ _key: "s3-9", _type: "span", text: "• **छूट की कार्यावधि**: 1 अक्टूबर 2026 से 31 मार्च 2041 तक (15 वर्ष का दीर्घकालिक लाभ)।" }]
          },
          {
            _key: "b3-img-2", _type: "image",
            asset: { _type: "reference", _ref: assetDiamondElectronicsId },
            alt: "Illustration of uncut diamonds, semiconductor microchips and Indian Government bond certificates",
          },
        ],
        bodyEn: [
          {
            _key: "b3-10", _type: "block", style: "normal",
            children: [{ _key: "s3-10", _type: "span", text: "• **G-Sec Investment**: Exemption on interest and capital gains for FIIs & BIS from April 1, 2026." }]
          },
          {
            _key: "b3-11", _type: "block", style: "normal",
            children: [{ _key: "s3-11", _type: "span", text: "• **Diamond Trade Relief**: Tax exemption on rough diamond sales in SNZs from Oct 1, 2026 to Mar 31, 2041." }]
          },
        ],
      },

      /* ── 4. Provisions 3 & 4: Electronics & Offshore Funds ────── */
      {
        _key: "sec-provisions-3-4",
        kind: "keyAspects",
        title: "इलेक्ट्रॉनिक्स विनिर्माण संवर्धन एवं विदेशी फंडों की सरलीकरण शर्तें",
        titleEn: "Electronics Manufacturing & Offshore Fund Regulation",
        body: [
          {
            _key: "b4-1", _type: "block", style: "h3",
            children: [{ _key: "s4-1", _type: "span", text: "3. इलेक्ट्रॉनिक्स विनिर्माण को बढ़ावा (Boosting Electronics Manufacturing)" }]
          },
          {
            _key: "b4-2", _type: "block", style: "normal",
            children: [{ _key: "s4-2", _type: "span", text: "• **प्रावधान**: सीमा शुल्क बंधित क्षेत्र (Customs Bonded Area) में इलेक्ट्रॉनिक घटकों के भंडारण पर कर छूट।" }]
          },
          {
            _key: "b4-3", _type: "block", style: "normal",
            children: [{ _key: "s4-3", _type: "span", text: "• **शामिल उत्पाद**: स्मार्टफोन, लैपटॉप, सर्वर और उप-असेंबली (Sub-assemblies)।" }]
          },
          {
            _key: "b4-4", _type: "block", style: "normal",
            children: [{ _key: "s4-4", _type: "span", text: "• **समय सीमा विस्तार**: पूंजीगत वस्तुओं एवं औजारों की आपूर्ति से जुड़ी कर छूट की सीमा **2030-31 से बढ़ाकर 2040-41** (10 वर्ष का विस्तार) कर दी गई है।" }]
          },
          {
            _key: "b4-5", _type: "block", style: "h3",
            children: [{ _key: "s4-5", _type: "span", text: "4. भारत से प्रबंधित विदेशी निवेश फंड (Foreign Investment Funds Managed from India)" }]
          },
          {
            _key: "b4-6", _type: "block", style: "normal",
            children: [{ _key: "s4-6", _type: "span", text: "• **हटाई गई 4 कढ़ी शर्तें (4 Criteria Removed)**:" }]
          },
          {
            _key: "b4-7", _type: "block", style: "normal",
            children: [{ _key: "s4-7", _type: "span", text: "• 1. न्यूनतम 25 सदस्यों की अनिवार्यता को समाप्त करना।" }]
          },
          {
        ...
        bodyEn: [
          {
            ...
            children: [{ _key: "s4-11", _type: "span", text: "• **Electronics Relief Extended**: Extended to 2040-41." }]
          },
          {
            _key: "b4-12", _type: "block", style: "normal",
            children: [{ _key: "s4-12", _type: "span", text: "• **4 Offshore Fund Rules Removed**: Removed 25 members rule, 10% investor cap, ₹100 Cr corpus rule, and 25% single entity limit." }]
          },
        ],
      },

      /* ── 5. Provisions 5 & 6: REIT/InvIT & Data Centers ──────── */
      {
        _key: "sec-provisions-5-6",
        kind: "keyAspects",
        title: "REIT, InvIT तथा डेटा सेंटर क्षेत्र हेतु कर नीतियाँ",
        titleEn: "REIT, InvIT & Data Center Sector Reforms",
        body: [
          {
            _key: "b5-1", _type: "block", style: "h3",
            children: [{ _key: "s5-1", _type: "span", text: "5. REIT एवं InvIT से संबंधित बदलाव (Real Estate & Infra Trusts)" }]
          },
          {
            _key: "b5-2", _type: "block", style: "normal",
            children: [{ _key: "s5-2", _type: "span", text: "• **REIT**: Real Estate Investment Trust (रियल एस्टेट इन्वेस्टमेंट ट्रस्ट)" }]
          },
          {
            _key: "b5-3", _type: "block", style: "normal",
            children: [{ _key: "s5-3", _type: "span", text: "• **InvIT**: Infrastructure Investment Trust (इन्फ्रास्ट्रक्चर इन्वेस्टमेंट ट्रस्ट)" }]
          },
          {
            _key: "b5-4", _type: "block", style: "normal",
            children: [{ _key: "s5-4", _type: "span", text: "• **अधिभार दर (Surcharge Rate) में वृद्धि**: व्यावसायिक ट्रस्टों के Special Purpose Vehicle (SPV) हेतु अधिभार दर **10% से बढ़ाकर 25%** की गई।" }]
          },
          {
            _key: "b5-5", _type: "block", style: "normal",
            children: [{ _key: "s5-5", _type: "span", text: "• **लाभांश छूट (Dividend Relief)**: SPV से यूनिट धारकों (Unitholders) को प्राप्त विशिष्ट लाभांश आय को कर छूट का प्रावधान।" }]
          },
          {
            _key: "b5-6", _type: "block", style: "h3",
            children: [{ _key: "s5-6", _type: "span", text: "6. डेटा सेंटर क्षेत्र (Data Center Sector)" }]
          },
          {
            _key: "b5-7", _type: "block", style: "normal",
            children: [{ _key: "s5-7", _type: "span", text: "• **प्रावधान**: विदेशी कंपनियों को डेटा सेंटर सेवाओं से होने वाली आय पर कर छूट हेतु कड़े प्रतिबंधों को हटाया गया।" }]
          },
          {
            _key: "b5-8", _type: "block", style: "normal",
            children: [{ _key: "s5-8", _type: "span", text: "• **विस्तार**: यह कर छूट भारतीय कंपनियों द्वारा पट्टे (Leased) पर लिए गए और संचालित किए जा रहे डेटा सेंटरों तक भी विस्तारित।" }]
          },
          {
        ...
        bodyEn: [
          {
            ...
            children: [{ _key: "s5-9", _type: "span", text: "• **REIT/InvIT SPV Surcharge**: Raised from 10% to 25%." }]
          },
          {
            _key: "b5-10", _type: "block", style: "normal",
            children: [{ _key: "s5-10", _type: "span", text: "• **Data Centers**: Relief extended to leased data center infrastructure operated by Indian firms." }]
          },
        ],
      },
      ...
      /* ── 6. Summary Sheet ───────────────────────────────────── */
      {
        ...
        titleEn: "Fast Revision Summary for MPPSC & UPSC Exams",
        body: [
          {
            _key: "b6-1", _type: "block", style: "normal",
            children: [{ _key: "s6-1", _type: "span", text: "• **नोडल मंत्रालय**: वित्त मंत्रालय (Ministry of Finance)" }]
          },
          {
            _key: "b6-2", _type: "block", style: "normal",
            children: [{ _key: "s6-2", _type: "span", text: "• **संशोधित मुख्य कानून**: आयकर अधिनियम 2025, वित्त अधिनियम 2026, भुगतान एवं निपटान प्रणाली अधिनियम 2007" }]
          },
          {
            _key: "b6-3", _type: "block", style: "normal",
            children: [{ _key: "s6-3", _type: "span", text: "• **हीरा उद्योग कर छूट कार्यावधि**: 1 अक्टूबर 2026 से 31 मार्च 2041 (15 वर्ष)" }]
          },
          {
            _key: "b6-4", _type: "block", style: "normal",
            children: [{ _key: "s6-4", _type: "span", text: "• **इलेक्ट्रॉनिक्स पूंजीगत वस्तु छूट सीमा**: 2040-41 तक विस्तारित" }]
          },
          {
            _key: "b6-5", _type: "block", style: "normal",
            children: [{ _key: "s6-5", _type: "span", text: "• **SPV अधिभार वृद्धि**: 10% से बढ़ाकर 25%" }]
          },
          {
            _key: "b6-6", _type: "block", style: "normal",
            children: [{ _key: "s6-6", _type: "span", text: "• **स्मरण सूत्र**: 2026 कराधान संशोधन = विदेशी निवेश + हीरा + इलेक्ट्रॉनिक्स + निवेश फंड + REIT/InvIT + डेटा सेंटर" }]
          },
        ],
        bodyEn: [
          {
            _key: "b6-7", _type: "block", style: "normal",
            children: [{ _key: "s6-7", _type: "span", text: "• **SPV Surcharge**: 10% to 25%" }]
          },
        ],
      },
    ],
    ...
    mcqs: [
      {
        ...
        explanationEn: "The Taxation and Other Laws (Amendment) Bill, 2026 is governed by the Ministry of Finance."
      },
      {
        ...
        explanationEn: "The bill amends the Income Tax Act 2025, Finance Act 2026, and Payment and Settlement Systems Act 2007."
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answerEn: "It is a major tax reform legislation passed by Parliament in August 2026."
      },
      {
      ...
      },
      {
        ...
        answer: "व्यावसायिक ट्रस्टों के Special Purpose Vehicle (SPV) हेतु अधिभार दर को 10% से बढ़ाकर 25% किया गया है।",
        answerEn: "Surcharge rate for REIT/InvIT SPVs increased from 10% to 25%."
      }
    ],
  ...
  try {
    ...
    console.log("✨ Successfully formatted and republished clean Taxation Bill 2026 to Sanity CMS!");
  } catch (err) {
