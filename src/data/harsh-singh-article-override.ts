export const harshSinghArticleData = {
  ...
  featuredImage: {
    ...
    altEn: "Harsh Singh celebrating his historic CWG 2026 Judo Gold Medal with the Indian Flag",
    ...
    captionEn: "Glasgow CWG 2026: 23-year-old Harsh Singh proudly celebrating with the Indian Tri-color after winning India's 1st Male Judo Gold Medal"
  },

  sections: [
    /* ── 1. Overview & Context (Who is Harsh Singh?) ──────────── */
    {
    ...
    /* ── 2. Thrilling Final: 41 Seconds Throw & Match Path ─────── */
    {
      ...
      body: [
        {
          _key: "b2-img-mascot",
          _type: "image",
          url: "/images/blog/harsh_singh_cwg_2026_mascot.png",
          ...
          altEn: "Harsh Singh on victory podium holding Gold Medal and CWG 2026 Mascot",
          ...
          captionEn: "CWG 2026 Glasgow: Harsh Singh displaying his Gold Medal and official mascot after winning Men's 60kg Judo title"
        },
        {
    ...
    /* ── 3. IJF Circuit Career & Delhi Roots ──────────────────── */
    {
      ...
      body: [
        {
          _key: "b3-img-closeup",
          _type: "image",
          url: "/images/blog/harsh_singh_cwg_2026_closeup.png",
          alt: "हर्ष सिंह कॉमनवेल्थ गेम्स 2026 जूडो स्वर्ण पदक प्रदर्शित करते हुए (Harsh Singh displaying Gold Medal Close-up)",
          altEn: "Harsh Singh displaying his historic CWG 2026 Gold Medal close-up",
          ...
          captionEn: "Historic Gold: 23-year-old Harsh Singh proudly showing India's first male CWG Judo Gold Medal"
        },
        {
    ...
    /* ── 4. Interlinking & Indian Gold Champions ──────────────── */
    {
    ...
    /* ── 5. MPPSC & UPSC Quick Revision Study Notes ───────────── */
    {
