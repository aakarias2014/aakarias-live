export const asmitaDeyArticleData = {
  ...
  featuredImage: {
    ...
    altEn: "Ashmita Dey celebrating historic Gold medal with Indian National Flag at Commonwealth Games 2026 Judo 48kg",
    ...
    captionEn: "Glasgow Commonwealth Games 2026: Ashmita Dey proudly holding the Indian Tri-color after winning India's first ever Gold medal in Judo"
  },

  sections: [
    /* ── 1. Overview & Context (Who is Asmita Dey?) ──────────── */
    {
      ...
      body: [
        ...
        },
        {
          ...
          children: [{
            _key: "s1-2",
            _type: "span",
            text: "अस्मिता डे ने फाइनल मुकाबले में कनाडा की शीर्ष खिलाड़ी **हेइडी क्वैच (Heidi Quach)** को अतिरिक्त समय ('गोल्डन स्कोर' / सडन डेथ) में पराजित कर यह स्वर्णिम उपलब्धि प्राप्त की। इस जीत से भारत की [**कॉमनवेल्थ गेम्स 2026 मेडल टैली**](/current-affairs/commonwealth-games-2026-updates-india-medal-tally) में स्वर्ण पदकों की संख्या बढ़कर 5 हो गई। इसी प्रतियोगिता में पुरुषों के 60किग्रा जूडो में [**हर्ष सिंह (Harsh Singh)**](/current-affairs/harsh-singh-biography-cwg-2026-gold-medal-judo) ने भी स्वर्ण पदक तथा महिलाओं के 57किग्रा में **यामिनी मौर्या** ने रजत पदक जीतकर भारतीय जूडो दल को अभूतपूर्व सफलता दिलाई।",
            textEn: "Ashmita Dey secured this golden milestone by defeating Canada's top seed **Heidi Quach** in the extra time ('Golden Score' / Sudden Death). This victory elevated India's gold count to 5 in the official [**CWG 2026 Medals Tally**](/en/current-affairs/commonwealth-games-2026-updates-india-medal-tally). In the same tournament, [**Harsh Singh**](/en/current-affairs/harsh-singh-biography-cwg-2026-gold-medal-judo) won Gold in Men's 60kg Judo and **Yamini Mourya** secured Silver in Women's 57kg Judo."
          }],
        },
        {
    ...
    /* ── 2. Emotional Victory: Father's Dream & UP Police Role ─── */
    {
    ...
    /* ── 3. CWG 2026 Match Path & Golden Score Victory ───────── */
    {
      ...
      body: [
        {
          ...
          _type: "image",
          url: "/images/blog/asmita_dey_cwg_2026_gold_medal_close_up.jpg",
          alt: "अस्मिता डे कॉमनवेल्थ गेम्स 2026 स्वर्ण पदक के साथ मुस्कराते हुए (Ashmita Dey Gold Medal Close Up)",
          altEn: "Ashmita Dey smiling with her CWG 2026 Gold Medal",
          caption: "ग्लासगो 2026: स्वर्णिम पदक के साथ अस्मिता डे - इप्पोन, युको और सडन डेथ में शानदार दबदबा दिखातीं भारतीय चैंपियन",
          captionEn: "Glasgow 2026: Ashmita Dey celebrating her historic Gold medal victory after a stellar performance in Ippon, Yuko and Sudden Death rounds"
        },
        {
    ...
    /* ── 4. Early Life, Athlete Origins & Bhopal SAI Training ── */
    {
      ...
      body: [
        {
          _key: "b3-img-heart",
          _type: "image",
          url: "/images/blog/asmita_dey_cwg_2026_gold_heart_pose.jpg",
          alt: "अस्मिता डे हाथ से हार्ट शेप बनाकर स्वर्ण पदक के साथ पोज़ देते हुए (Ashmita Dey Heart Pose CWG 2026)",
          altEn: "Ashmita Dey posing with heart gesture and her CWG 2026 Judo Gold Medal",
          caption: "त्रिपुरा के बेलोनिया से भोपाल SAI एकेडमी तक: कठिनाइयों को मात देकर विश्व मंच पर चमकतीं अस्मिता डे",
          captionEn: "From Belonia (Tripura) to SAI Bhopal: Ashmita Dey posing with her historic Gold medal after overcoming immense challenges"
        },
        {
    ...
    /* ── 5. Interlinking & Indian Gold Winners Comparison ────── */
    {
