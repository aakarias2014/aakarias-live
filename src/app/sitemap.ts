...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteConfig.url}/awards-and-honors`, changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${siteConfig.url}/upsc`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${siteConfig.url}/mppsc`, changeFrequency: "weekly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc-notes`, changeFrequency: "weekly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc/syllabus-2026`, changeFrequency: "monthly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc/mains-syllabus`, changeFrequency: "monthly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc/prelims-syllabus`, changeFrequency: "monthly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc/previous-year-papers`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${siteConfig.url}/mppsc/question-paper-2016`, changeFrequency: "weekly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc/books-and-ncert-list`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${siteConfig.url}/mppsc/toppers-copy`, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${siteConfig.url}/test-series`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${siteConfig.url}/media-center`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${siteConfig.url}/free-pdf`, changeFrequency: "weekly", priority: 0.75 },
    ...
    { url: `${siteConfig.url}/important-days`, changeFrequency: "daily", priority: 0.85 },
    { url: `${siteConfig.url}/ncert-books`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${siteConfig.url}/pyq`, changeFrequency: "weekly", priority: 0.85 },
    { url: `${siteConfig.url}/daily-quiz`, changeFrequency: "daily", priority: 0.8 },
    { url: `${siteConfig.url}/faculty`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${siteConfig.url}/ncert-books-for-mppsc`, changeFrequency: "weekly", priority: 0.95 },
    { url: `${siteConfig.url}/mppsc-mains-books`, changeFrequency: "weekly", priority: 0.95 },
    ...
    { url: `${siteConfig.url}/en/awards-and-honors`, changeFrequency: "daily", priority: 0.75 },
    ...
    { url: `${siteConfig.url}/en/mppsc/previous-year-papers`, changeFrequency: "weekly", priority: 0.85 },
    { url: `${siteConfig.url}/en/mppsc/question-paper-2016`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${siteConfig.url}/en/mppsc/books-and-ncert-list`, changeFrequency: "weekly", priority: 0.85 },
