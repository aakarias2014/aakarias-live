      ...
      <Section>
        <Container size="narrow">
          <div className="prose prose-aakar dark:prose-invert max-w-none">
            ...
            <h3>खंड (ब) — भूगोल (Geography) (150 अंक)</h3>

            <h4>इकाई-1 भारत का भौतिक भूगोल (Physical Geography of India)</h4>
            <ul>
              <li>
                <strong>प्रमुख भू-आकृतिक लक्षण</strong> — पर्वत, पठार, मैदान, नदियाँ, जल-विभाजक (Water Divide in India), झीलें एवं हिमनद।
              </li>
              <li>
                <strong>भारत के भू-आकृतिक प्रदेश</strong> — उत्तर का पर्वतीय प्रदेश (हिमालय), विशाल मैदानी प्रदेश, प्रायद्वीपीय पठार, तटीय मैदान एवं द्वीप समूह।
              </li>
              <li>
                <strong>जलवायु एवं मानसून प्रणाली</strong> — भारतीय मानसून की उत्पत्ति एवं विशेषताएँ, चक्रवात (शीतोष्ण एवं उष्णकटिबंधीय), एल-नीनो (El Nino), ला-नीना (La Nina) तथा इंडियन ओशन डिपोल (IOD) का प्रभाव।
              </li>
            </ul>

            <h4>इकाई-2 भारत का कृषि एवं जल संसाधन (Agriculture & Water Resources)</h4>
            <ul>
              <li>
                <strong>कृषि परिदृश्य</strong> — प्रमुख फसलें, कृषि पद्धतियाँ, बाजरा/श्री अन्न (Millets), हरित क्रांति, सिंचाई के साधन एवं कृषि क्रांति।
              </li>
              <li>
                <strong>जल संसाधन प्रबंधन</strong> — वर्षा जल संचयन (Rainwater Harvesting), नदियों को आपस में जोड़ना (Interlinking of Rivers), बहुउद्देशीय नदी घाटी परियोजनाएँ।
              </li>
            </ul>

            <h4>इकाई-3 भारत के प्राकृतिक संसाधन एवं उद्योग (Natural Resources & Industries)</h4>
            <ul>
              <li>
                <strong>प्राकृतिक संसाधन</strong> — वन, खनिज एवं ऊर्जा संसाधन (कोयला, पेट्रोलियम, नवीकरणीय ऊर्जा — सौर, पवन, बायोमास)।
              </li>
              <li>
                <strong>उद्योग एवं आर्थिक भूगोल</strong> — भारत के प्रमुख औद्योगिक प्रदेश, लोहा-इस्पात, कपड़ा, सीमेंट, खाद्य प्रसंस्करण उद्योग, MSME एवं कुटीर उद्योग।
              </li>
            </ul>

            <h4>इकाई-4 आपदाएँ, पर्यावरण एवं आधुनिक तकनीक (Disasters & Advanced Tech)</h4>
            <ul>
              <li>
                <strong>प्राकृतिक एवं मानव निर्मित आपदाएँ</strong> — भूकंप, सुनामी, बाढ़, सूखा, भूस्खलन, चक्रवात एवं आपदा प्रबंधन नीतियाँ।
              </li>
              <li>
                <strong>पर्यावरण एवं आधुनिक तकनीक</strong> — प्रदूषण नियंत्रण, रिमोट सेंसिंग (Remote Sensing), GIS (भौगोलिक सूचना प्रणाली) एवं GPS के अनुप्रयोग।
              </li>
            </ul>

            <h4>इकाई-5 मध्य प्रदेश का भूगोल (Geography of Madhya Pradesh)</h4>
            <ul>
              <li>
                <strong>भौतिक एवं प्राकृतिक विशेषताएँ</strong> — प्रमुख भू-आकृतिक प्रदेश (मालवा पठार, विंध्याचल, सतपुड़ा, नर्मदा-सोन घाटी, बुंदेलखंड, रीवा-पन्ना, बघेलखंड)।
              </li>
              <li>
                <strong>अपवाह तंत्र एवं संसाधन</strong> — प्रमुख नदियाँ, जलवायु, ऋतुएँ, मिट्टियों के प्रकार, प्राकृतिक वनस्पति, खनिज, उद्योग एवं जनसांख्यिकी (Demography)।
              </li>
            </ul>
