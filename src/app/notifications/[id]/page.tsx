...
import { CalendarDays, ArrowLeft, ExternalLink, Download, Share2, HelpCircle, FileText } from "lucide-react";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const keywords = isConstable
    ? [
        ...
        "mp police constable 2026 vacancy kab aayegi",
        "mp police constable exam date 2026",
        "mp police constable notification 2026",
        ...
        <Container size="wide">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
            ...
            <main className="lg:col-span-8 space-y-8 min-w-0">
              ...
              {/* Rich Visual Rulebook Overview for Patwari, MPSI, MP Police Constable or Dynamic Article Body */}
              ...
              <div className="rounded-3xl border border-primary/30 bg-primary/5 p-6 sm:p-8 space-y-4 shadow-soft">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  आधिकारिक नियमपुस्तिका (Rulebook PDF) तथा विस्तृत परीक्षा पाठ्यक्रम (Syllabus PDF) डाउनलोड करें अथवा MP Online कियोस्क/पोर्टल के माध्यम से सीधे फॉर्म भरें:
                </p>
              ...
              {(n.slug?.includes("constable") || n.id?.includes("constable")) ? (
                <MpPoliceConstablePaidCourseBanner variant="full" locale="hi" />
              ) : (n.slug?.includes("mpsi") || n.id?.includes("mpsi")) ? (
            ...
            <aside className="lg:col-span-4 space-y-6">
              ...
              {(n.slug?.includes("constable") || n.id?.includes("constable")) ? (
                <MpPoliceConstablePaidCourseBanner variant="sidebar" locale="hi" />
              ) : (n.slug?.includes("mpsi") || n.id?.includes("mpsi")) ? (
