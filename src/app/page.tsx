...
export const metadata = buildMetadata({
  ...
  description: "आकार IAS (Aakar IAS) — इंदौर की सर्वश्रेष्ठ MPPSC कोचिंग। MPPSC Online Coaching, लाइव क्लासेज, डेली करेंट अफेयर्स, मुख्य परीक्षा उत्तर लेखन, टेस्ट सीरीज, टॉपर्स आंसर कॉपी और फ्री नोट्स PDF।",
  path: "/",
  keywords: [
    "Aakar IAS",
    "Aakar IAS Indore",
