          ...
          <div className="lg:col-span-2 space-y-12 overflow-x-hidden">
            ...
            <div className="block lg:hidden space-y-10">
              ...
              <div className="text-center relative py-8 px-4 overflow-hidden rounded-3xl bg-primary/5 border border-primary/10">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-muted-foreground max-w-xs mx-auto mb-6">
                    Download Aakar IAS App now for the best preparation of UPSC, MPPSC & other Govt. Exams.
                  </p>
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-bold text-foreground text-center sm:text-left">Choose Platform</h3>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <a href={playStoreUrl} target="_blank" rel="noopener noreferrer" className="bg-card p-3.5 rounded-2xl flex flex-col items-center justify-between text-center border border-primary/30 bg-primary/5 shadow-soft hover:shadow-soft-lg transition-all cursor-pointer group min-h-[135px]">
                    ...
                    <span className="mt-2 text-[10px] font-bold text-primary flex items-center gap-0.5">
                      Download <ArrowRight className="h-3 w-3 group-hover:translate-x-0.5 transition-transform" />
                    </span>
                  </a>
