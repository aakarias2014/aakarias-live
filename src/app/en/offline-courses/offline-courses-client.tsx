    ...
    <div className="space-y-16 pb-24">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-zinc-950 text-white border-b border-white/10">
        ...
        <Container size="wide" className="relative py-10 sm:py-16 lg:py-20">
          <div className="mb-6">
            <Breadcrumb items={[{ name: "Offline Courses" }]} />
          </div>
          ...
          <AnimatedSection variant="scale-in" duration={0.8} className="mx-auto max-w-4xl text-center space-y-5">
            <div className="flex flex-wrap items-center justify-center gap-2">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 border border-white/15 px-3.5 py-1 text-xs font-bold text-white/90 uppercase tracking-wider backdrop-blur-md">
                📍 Indore &amp; Prayagraj Campuses
              </span>
            </div>

            <h1 className="text-balance text-3xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.15]">
              Offline Classroom Programs &amp; Courses
            </h1>

            <p className="mt-4 text-pretty text-sm sm:text-lg text-zinc-300 max-w-3xl mx-auto leading-relaxed">
              Achieve success under the personal guidance of experienced faculty at Indore &amp; Prayagraj centers. Disciplined academic environment, updated study materials, and 1-on-1 mentorship.
            </p>
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <a href="https://wa.me/919425055050?text=Hello%20Aakar%20IAS,%20I%20want%20information%20about%20offline%20batches" target="_blank" rel="noopener noreferrer">
                  <MessageSquare className="h-4 w-4 text-emerald-400" /> WhatsApp Chat
                </a>
              </Button>
            </div>
          </AnimatedSection>
                ...
                {selectedCenter.batches.map((batch, index) => (
                  <Card key={index} className="relative overflow-hidden border border-border/70 hover:border-primary/40 hover:shadow-xl transition-all duration-300 flex flex-col justify-between group rounded-2xl bg-card">
                    ...
                    <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                      ...
                      <h4 className="text-lg sm:text-xl font-black text-foreground group-hover:text-primary transition-colors leading-snug">
                        {batch.title}
                      </h4>
                      ...
                      <div className="space-y-2 border-t border-border/50 pt-3 text-xs sm:text-sm text-muted-foreground">
                        <div className="flex items-center gap-2.5">
                          <div className="h-7 w-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0">
                            <Calendar className="h-3.5 w-3.5" />
                          </div>
                          <span>Starts: <strong className="text-foreground font-semibold">{batch.startDate}</strong></span>
                        </div>
                        <div className="flex items-center gap-2.5">
                          <div className="h-7 w-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0">
                            <Clock className="h-3.5 w-3.5" />
                          </div>
                          <span>Timing: <strong className="text-foreground font-semibold">{batch.time}</strong></span>
                        </div>
                        <div className="flex items-center gap-2.5">
                          <div className="h-7 w-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0">
                            <GraduationCap className="h-3.5 w-3.5" />
                          </div>
                          <span>Medium: <strong className="text-foreground font-semibold">{batch.medium}</strong></span>
                        </div>
                      </div>
                    </div>
        ...
        <Container size="wide">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-2.5 sm:gap-5">
            {displayHindiMentors.map((fac, index) => (
              <Link key={index} href="/en/faculty" className="block group">
