...
const SUBJECTS = [
  ...
  { slug: "awards-and-honors", title: "महत्वपूर्ण पुरस्कार एवं सम्मान", titleEn: "Awards & Honors", Icon: Award },
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-secondary text-secondary-foreground py-12 sm:py-16">
        ...
        <Container size="wide" className="relative">
          <Breadcrumb items={[{ name: "सामान्य अध्ययन (General Studies)" }]} variant="light" />
