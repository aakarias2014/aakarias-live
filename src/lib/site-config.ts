...
export const siteConfig = {
  name: "Aakar IAS",
  shortName: "Aakar IAS",
  siteTitle: "Aakar IAS | Best MPPSC & UPSC Coaching in Indore | Test Series & Notes",
  siteTitleHi: "आकार IAS | MPPSC व UPSC सर्वश्रेष्ठ कोचिंग इंदौर | टेस्ट सीरीज व नोट्स",
  ...
  keywords: [
    ...
    "Aakar IAS Indore Madhya Pradesh",
    ...
    "Aakar IAS Notes PDF Free Download",
    ...
    "Aakar IAS Indore Director",
    "Aakar IAS Faculty",
    "Aakar IAS Fee",
    "Aakar IAS Indore Fees Structure",
...
export const navigationConfig: MegaNavItem[] = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { title: "पर्यावरण और जैव विविधता", titleEn: "Environment & Ecology", href: "/general-awareness?subject=environment" },
  ...
  },
  {
    ...
    isMega: true,
    dropdown: [
      { title: "पाठ्यक्रम 2026", titleEn: "Syllabus 2026", href: "/mppsc/syllabus-2026" },
      { title: "नोट्स PDF", titleEn: "Notes PDF", href: "/mppsc-notes" },
      ...
      { title: "टेस्ट सीरीज", titleEn: "Test Series", href: "/test-series" },
      { title: "रणनीति व सामान्य अध्ययन", titleEn: "Strategy & GS", href: "/mppsc" },
      { title: "सर्वश्रेष्ठ MPPSC कोचिंग इंदौर", titleEn: "Best MPPSC Coaching in Indore", href: "/best-mppsc-coaching-in-indore" },
      { title: "MPPSC कोचिंग फीस", titleEn: "MPPSC Coaching Fees", href: "/mppsc-coaching-fees-in-indore" },
      { title: "MPPSC ऑनलाइन कोचिंग", titleEn: "MPPSC Online Coaching", href: "/mppsc-online-coaching" },
      { title: "MPPSC अंग्रेजी माध्यम", titleEn: "MPPSC English Medium", href: "/mppsc-english-medium-coaching" },
      { title: "मेन्स आंसर राइटिंग", titleEn: "Mains Answer Writing", href: "/mppsc-mains-answer-writing" },
      { title: "NCERT पुस्तकें", titleEn: "NCERT Books for MPPSC", href: "/ncert-books-for-mppsc" },
      { title: "MPPSC मेन्स बुक्स", titleEn: "MPPSC Mains Books", href: "/mppsc-mains-books" },
    ],
  },
  {
...
export const footerNav: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      { title: "Daily Current Affairs", href: "/current-affairs" },
      { title: "Weekly Current Affairs", href: "/weekly" },
      { title: "Monthly Current Affairs", href: "/monthly" },
      { title: "Monthly PDF", href: "/monthly-pdf" },
      { title: "CA Quiz", href: "/current-affairs/quiz" },
    ],
  },
  {
    title: "Resources",
    items: [
      { title: "MPPSC Previous Year Papers", href: "/mppsc/previous-year-papers" },
      { title: "Free PDF Library", href: "/free-pdf" },
      { title: "NCERT Books", href: "/ncert-books" },
      { title: "Aakar IAS App Download", href: "/download" },
  ...
  },
  {
    title: "Company",
    items: [
      { title: "About Aakar IAS", href: "/about" },
      { title: "Contact & Enquiry", href: "/contact" },
      { title: "Faculty", href: "/faculty" },
      { title: "Selections & Toppers", href: "/selections" },
    ],
  },
  {
    title: "Legal",
